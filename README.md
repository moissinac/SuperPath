...
* #_idOfMyChunk_ 
insert a copy of the chunk with id _idOfMyChunk_ (a | must follow the id; it's the separator with what follows)

* !_idOfMyChunk_
insert a copy of the chunk with id _idOfMyChunk_  (a | must follow the id; it's the separator with what follows) but after reversing the commands (from the end to the begining, and processing them to follow the same geometry from the end to the begining)
